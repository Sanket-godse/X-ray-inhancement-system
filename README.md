...
# Installation
Clone the repository with `git clone git@github.com:Sanket-godse/X-ray-inhancement-system.git`.  
Run `main.py` file in the repository.

# Demonstration
To run the demonstration, run `main.py` and then change the path of image for different image in main file.